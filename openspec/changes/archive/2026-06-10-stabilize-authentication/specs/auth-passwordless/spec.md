...
Allow users to sign in without a password, via either a magic link sent to their email or a one-time 6-digit OTP, gated behind the `AUTH_PASSWORDLESS_ENABLED` feature flag.
