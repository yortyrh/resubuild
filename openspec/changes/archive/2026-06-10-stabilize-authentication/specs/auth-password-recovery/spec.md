...
Allow a user who has forgotten their password to receive a recovery email and set a new password, gated behind the `AUTH_FORGOT_PASSWORD_ENABLED` feature flag.
