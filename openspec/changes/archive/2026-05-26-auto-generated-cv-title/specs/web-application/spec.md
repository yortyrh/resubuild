...
**Reason**: Document title is derived from Basics and synced on basics writes; title-only PATCH is no longer part of the product UX.

**Migration**: Update Basics name/label to change the displayed title; use item-scoped saves for resume body sections as today.
