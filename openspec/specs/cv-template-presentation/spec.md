# CV template presentation

## Purpose

Specify per-CV, per-template layout configuration (section order, visibility, labels, and field toggles) and its integration with server-side resume HTML export.
