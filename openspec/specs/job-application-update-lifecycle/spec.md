# job-application-update-lifecycle Specification

## Purpose

Safe two-phase application update workflow: stage replacement applications off-list, then swap active records only after successful completion.
