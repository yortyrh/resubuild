...
Ensure every persisted CV document conforms to the JSON Resume standard used by the ecosystem, using a single shared schema artifact and server-side validation before writes.
