...
export const outputs = [
  { file: 'apps/web/public/icon.png', size: 512, margin: 0.1, transparent: false },
  { file: 'apps/web/public/icon-192x192.png', size: 192, margin: 0.1, transparent: false },
  { file: 'apps/web/public/icon-512x512.png', size: 512, margin: 0.1, transparent: false },
  {
  ...
  { file: 'apps/web/public/apple-touch-icon.png', size: 180, margin: 0.1, transparent: false },
  {
